        ...
        return(
            <Container className={'notificationOption'}>
                <Form id="notificationOptions">
                    ...
                    <body>
                        <br/>
                        <small>Do you want to allow emails to be sent directly to you?</small>
                    ...
                    <body>
                        <br/>
                      <small>Do you want to turn on push notifications from Dicker Dashboard?</small>
                        <Button onClick={this.handleClickAllowPush}>
